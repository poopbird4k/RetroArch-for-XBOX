...
DEFAULT_SUBLABEL_MACRO(action_bind_sublabel_update_cg_shaders,                             MENU_ENUM_SUBLABEL_UPDATE_CG_SHADERS)
DEFAULT_SUBLABEL_MACRO(action_bind_sublabel_update_glsl_shaders,                           MENU_ENUM_SUBLABEL_UPDATE_GLSL_SHADERS)
