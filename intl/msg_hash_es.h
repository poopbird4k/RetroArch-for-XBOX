...
MSG_HASH(
   ...
   "Cambie la configuración del controlador y el teclado."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Cambiar la configuración de superposiciones y notificaciones."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Análisis configurable basado en los nombres de las bases de datos."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Elimine la plataforma de los nombres de las listas de reproducción. Por ejemplo, «Consola - Sony PlayStation» pasaría a ser «Sony PlayStation»."
   )
MSG_HASH(
