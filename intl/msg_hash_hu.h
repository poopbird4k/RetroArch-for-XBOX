...
MSG_HASH(
   ...
   "A rátétek és értesítések beállításainak módosítása."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Távolítsa el a platformot a lejátszási listák nevéből. Például, \"Vigasztal - Sony PlayStation\" helyett \"Sony PlayStation\" jelenik meg."
   )
MSG_HASH(
