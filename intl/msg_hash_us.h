...
MSG_HASH(
   ...
   "Download borders for arcade, handheld and consoles."
   )
...
MSG_HASH(
   ...
   "Change display overlay and on-screen notification settings."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Configurable scan based on the names of the databases."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Remove the platform names from the playlists. For example, 'Console - Sony PlayStation' becomes 'Sony PlayStation'."
   )
MSG_HASH(
