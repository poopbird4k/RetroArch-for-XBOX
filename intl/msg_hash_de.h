...
MSG_HASH(
   ...
   "Rahmen für Arcade, Handheld und Konsolen herunterladen."
   )
MSG_HASH(
...
MSG_HASH(
   MENU_ENUM_SUBLABEL_UPDATE_GLSL_SHADERS,
   "-GLSL-SUBLABEL"
   )
MSG_HASH(
...
MSG_HASH(
   MENU_ENUM_SUBLABEL_UPDATE_CG_SHADERS,
   "-CG-SUBLABEL"
   )
MSG_HASH(
...
MSG_HASH(
   MENU_ENUM_SUBLABEL_UPDATE_SLANG_SHADERS,
   "Rahmen für Arcade, Handheld und Konsolen herunterladen."
   )
...
MSG_HASH(
   ...
   "Einstellungen für Overlays und Benachrichtigungen ändern."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Konfigurierbarer Scan basierend auf den Namen der Datenbanken."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Die Platform aus den Wiedergabelistennamen entfernen. Zum Beispiel wird \"Konsole - Sony PlayStation\" zu \"Sony PlayStation\"."
   )
MSG_HASH(
