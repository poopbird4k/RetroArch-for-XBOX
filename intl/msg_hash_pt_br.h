...
MSG_HASH(
   ...
   "Altere as configurações de sobreposições e notificações."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Remova a plataforma dos nomes das listas de reprodução. Por exemplo, \"Consolar - Sony PlayStation\" se torna \"Sony PlayStation\"."
   )
MSG_HASH(
