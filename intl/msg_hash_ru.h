...
MSG_HASH(
   ...
   "Измените настройки наложений и уведомлений."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Удалите платформу из названий плейлистов. Например, 'Консоль - Sony PlayStation' будет преобразовано в 'Sony PlayStation'."
   )
MSG_HASH(
