...
MSG_HASH(
   ...
   "Modificare le impostazioni del controller e della tastiera."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Modificare le impostazioni per le sovrapposizioni e le notifiche."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Scansione configurabile in base ai nomi dei database."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Rimuovi la piattaforma dai nomi delle playlist. Ad esempio, 'Confortare - Sony PlayStation' diventa 'Sony PlayStation'."
   )
MSG_HASH(
