...
MSG_HASH(
   ...
   "Modifiez les paramètres de la manette et du clavier."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Modifiez les paramètres des superpositions et des notifications."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Analyse configurable basée sur les noms des bases de données."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Supprimez la plateforme des noms de playlist. Par exemple, 'Consoler - Sony PlayStation' deviendra 'Sony PlayStation'."
   )
MSG_HASH(
