...
MSG_HASH(
   ...
   "Muuta näytön peittokuvan ja näytön ilmoitusasetuksia."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Poista alusta soittolistojen nimistä. Esimerkiksi \"Konsoli - Sony PlayStation\" muuttuu muotoon \"Sony PlayStation\"."
   )
MSG_HASH(
